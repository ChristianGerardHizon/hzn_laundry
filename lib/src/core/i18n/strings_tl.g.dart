...
class _TranslationsOrganizationsTl implements TranslationsOrganizationsEn {
	...
	@override String get consumableUsage => 'Paggamit ng consumable';
	@override String get sendHistoryEmails => 'Magpadala ng order history emails';
	@override String get requireMachine => 'Kailangan ang machine';
...
class _TranslationsSubscriptionsTl implements TranslationsSubscriptionsEn {
	...
	@override String get enforceLockout => 'I-lock ang access pagkatapos ng grace';
	@override String get enforcementHint => 'Kapag naka-off, puwede pa ring magbayad ang orgs nang kusa — walang banner, alert, o lock screen.';
...
extension on TranslationsTl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'organizations.consumableUsage' => 'Paggamit ng consumable',
			'organizations.sendHistoryEmails' => 'Magpadala ng order history emails',
			'organizations.requireMachine' => 'Kailangan ang machine',
			...
			'subscriptions.enforceLockout' => 'I-lock ang access pagkatapos ng grace',
			'subscriptions.enforcementHint' => 'Kapag naka-off, puwede pa ring magbayad ang orgs nang kusa — walang banner, alert, o lock screen.',
